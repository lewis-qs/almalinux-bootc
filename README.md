...
| --- | --- | --- | --- |
| kernel | `5.14.0-687.42.1` | `6.12.0-211.49.1` | `6.12.0-250` |
| bootc | `1.16.4-1` | `1.15.2-1` | `1.16.2-1` |
| systemd | `252-67` | `257-23` | `257-30` |
| podman | `5.8.2-6` | `5.8.2-5` | `6.0.1-1` |
| dnf | `4.14.0-34` | `4.20.0-22` | `4.20.0-26` |
| ostree | `2025.7-1` | `2025.7-1` | `2026.2-1` |
| NetworkManager | `1.54.3-5` | `1.56.0-2` | `1.58~rc1-1` |
